...
export function FormyxaToolbar({
  ...
  const tinyIconBtn =
  "inline-flex h-10 w-10 items-center justify-center rounded-md  text-slate-700 hover:bg-slate-100 active:bg-slate-200 focus:outline-none focus:ring-2 focus:ring-slate-300";
  ...
  return (
    <div className="sticky top-0 z-50 bg-white border-b border-slate-200 shadow-sm">
      ...
      <div className="h-14 flex items-center justify-between px-4 border-b border-slate-100">
        <div className="flex items-center gap-4 flex-1 min-w-0">
          <div className="flex items-center gap-2">
            ...
            <span className="text-slate-900 font-semibold">Formyxa</span>
          </div>
          <div className="h-5 w-px bg-slate-200" />
          <input
            value={documentName}
            onChange={(e) => onDocumentNameChange(e.target.value)}
            className="text-slate-900 outline-none border-none bg-transparent hover:bg-slate-50 px-3 py-1.5 rounded-lg transition-colors min-w-0 flex-1 max-w-xs"
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            disabled={saving}
            onClick={onExport}
            className="px-5 py-2 bg-primary hover:bg-primary/90 text-white rounded-lg transition-colors flex items-center gap-2 shadow-sm disabled:opacity-50"
          >
      ...
      {/* Row 2 */}
      <div className="h-14 flex items-center px-4 gap-2 overflow-visible">
